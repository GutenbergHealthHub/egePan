              ...
              >
                ...
                >
                  <Text style={[localStyle.p, localStyle.center]}>
                    ...
                    Gesundheitswesen“ (S.A.M.) im Rahmen von PREPARED (NUM 2.0)
                  </Text>
                  ...
                  <Text style={localStyle.p}>
                    ...
                    Studie an unserer Klinik informieren und nach Ihrem
                    Interesse zur freiwilligen Studienteilnahme fragen. Bitte
                    lesen Sie sich dieses Informationsschreiben sorgfältig
                    durch. Sollten Sie weiterführende Fragen hierzu haben,
                    stehen wir Ihnen hierfür gerne zur Verfügung. Sie können uns
                    per E-Mail (PSY.NUM@med.uni-muenchen.de) erreichen. Die
                    vorliegende Studie wurde durch die Ethikkommission des
                    Landes Rheinland-Pfalz ethisch geprüft und zustimmend
                    bewertet, zusätzlich erfolgte ein zustimmendes Ethikvotum
                    der Ethikkommission am LMU Klinikum (Projektnummer:
                    23-0230).
                  </Text>
                  ...
                  <Text style={localStyle.p}>
                    ...
                    Projektteil des <Text style={localStyle.b}>PREPARED</Text>{" "}
                    Verbundforschungsprojekts des LMU Klinikums (Klinik für
                    Psychiatrie und Psychotherapie) und der Universitätsmedizin
                    Mainz (Klinik und Poliklinik für Psychosomatische Medizin
                    und Psychotherapie & Klinik für Psychiatrie und
                    Psychotherapie). PREPARED wird im Rahmen des{" "}
                    ...
                    unter der Gesamtprojektleitung von Prof. Dr. Jochen Schmitt
                    und Prof. Dr. Simone Scheithauer. Die Wissenschaftler:innen
                    der Studie haben sich zum Ziel gesetzt, Mitarbeitenden von
                    Kliniken in Deutschland die Möglichkeit zu geben, ihre
                    mentale Gesundheit am Ende bzw. nach der COVID-19-Pandemie
                    zu monitoren. Dies soll dazu beitragen, bei einer
                    zukünftigen Gesundheitskrise oder -katastrophe zeitnah die
                    mentale Gesundheit von Mitarbeitenden in Kliniken erfassen
                    und evaluieren zu können. Darüber hinaus verfolgt die Studie
                    weitere wissenschaftliche Fragestellungen. Zu diesen zählen
                    beispielsweise die Fragen, wie Personen belastende
                    Lebensumstände und Stress über einen längeren Zeitraum
                    bewältigen, um Rückschlüsse auf mögliche Risikofaktoren und
                    Interventionen zu erhalten. Besonders die Faktoren Burnout
                    als arbeitsbezogenes Beanspruchungsmerkmal soll untersucht
                    und präventive Faktoren (z. B. Selbstwirksamkeit oder
                    soziale Unterstützung) zur Vermeidung analysiert werden.
                    Ziel der Studie ist, Merkmale zu identifizieren, die vor der
                    Entwicklung psychischer Störungen schützen. Bitte beachten
                    Sie, dass Sie an der Studie nur teilnehmen können, wenn Sie
                  ...
                  <Text style={localStyle.p}>
                    ...
                    Im Rahmen der Studie möchten wir Ihnen über einen Zeitraum
                    von drei Monaten in einem zwei-wöchentlichen Rhythmus Fragen
                    zu Ihrer psychischen Gesundheit stellen. Insgesamt werden
                    Sie 7 Fragebögen (1 Start-Fragebogen, 6 wöchentliche
                    Fragebögen) ausfüllen können. Die Studie startet im Frühjahr
                    2023. Der Zeitraum der Befragung erstreckt sich über drei
                    Monate.
                  </Text>
                  <Text style={localStyle.p}>
                    <Text style={localStyle.b}>Voraussetzungen:{"\n"}</Text>
                    Um an der Studie teilnehmen zu können, müssen Sie sich die
                    für die Studie entwickelte S.A.M.-App auf Ihr Smartphone
                    ...
                    (https://num-compass.science/de/), welches ebenfalls im
                    Rahmen des Netzwerks Universitätsmedizin (NUM) BMBF
                    gefördert wird (Förderkennzeichen: 01KX2021). Nachdem Sie
                    die App heruntergeladen und auf Ihrem Smartphone installiert
                    haben, wird Ihnen beim erstmaligen Öffnen der App die
                    Einwilligungserklärung zur Teilnahme an der Studie und
                    Nutzung der App angezeigt. Wenn Sie der Nutzung zustimmen,
                    können Sie die App nutzen und es wird Ihnen im Anschluss
                    eine persönliche Benutzer-ID zugewiesen (ein sogenanntes
                    “Pseudonym”, bzw. Pseudonymisierungsschlüssel), die Sie
                    jederzeit in der App einsehen können. Diese sollte notiert
                    werden, falls Sie sich versehentlich ausloggen. Im Anschluss
                    können Sie mit der Bearbeitung des ersten Fragebogens
                    beginnen. Es müssen alle Pflichtfelder ausgefüllt werden,
                    damit der Fragebogen abgesendet werden kann. Sie werden
                    wöchentlich per sog. “Push-Notification”, also einer
                    Benachrichtigung auf Ihrem Smartphone, darüber informiert,
                    dass ein neuer Fragebogen zum Ausfüllen vorliegt. Zum Ende
                    der Studie erhalten Sie ebenfalls eine Push-Notification mit
                  ...
                  <Text style={localStyle.p}>
                    ...
                    Mitarbeitenden in Kliniken zu leisten, indem wir Ihnen die
                    Möglichkeit geben, selbst ihre mentale Gesundheit zu
                  ...
                  <Text style={localStyle.p}>
                    ...
                    auf die Sie einfach per Klick zugreifen können. So liegt es
                    in Ihrer Hand, zu bewerten, ob Sie auf Grundlage Ihrer
                    Ergebnisse externe Beratungs- oder Unterstützungsangebote in
                  ...
                  <Text style={localStyle.p}>
                    ...
                    DSGVO als Verarbeitung besonderer Kategorien
                    personenbezogener Daten. Der Studiendurchführer versichert,
                    entsprechende technische und organisatorische Maßnahmen zu
                    ergreifen, um eine rechtskonforme Verarbeitung Ihrer Daten
                    zu gewährleisten.
                  </Text>
                  <Text style={[localStyle.b, localStyle.center, localStyle.u]}>
                  ...
                  <Text style={localStyle.p}>
                    ...
                    entstehen keine Nachteile durch Versagen der Einwilligung.
                    Sie können zudem jederzeit und ohne Angabe von Gründen Ihre
                    Einwilligung zur Teilnahme an der Studie widerrufen
                    (schriftlich oder per E-Mail) und der Weiterverarbeitung
                    Ihrer Daten widersprechen, ohne dass Ihnen dadurch Nachteile
                    entstehen. Ihre personenbeziehbaren Daten werden in diesem
                    Fall gelöscht. Die zu diesem Zeitpunkt bereits
                    anonymisierten Daten können nicht gelöscht werden, da Ihnen
                    diese Daten nicht mehr zugeordnet werden können. Ihr
                  ...
                  <Text style={localStyle.p}>
                    Im Rahmen der Studie werden explizit keine personenbezogenen
                    Daten von Ihnen wie z.B. Ihr Name, Adresse, Email-Adresse
                    oder Geburtsdatum erhoben. Sämtliche sonstige, zur
                    Auswertung notwendige Metadaten werden in pseudonymisierter
                    Form erhoben. Pseudonymisiert bedeutet, dass Ihre
                    personenbezogenen Daten durch einen wertneutralen Code (z.B.
                    XYZ01) ersetzt werden. Über den wertneutralen Code kann das
                    Studienpersonal nach Beendigung der Studie die von Ihnen
                    übersandten Fragebögen zuordnen und auswerten. Eine Beratung
                    durch den Datenschutzbeauftragten der Universitätsmedizin
                    Mainz hat stattgefunden.
                  </Text>
                  <Text style={localStyle.p}>
                    ...
                    Firma Google übermittelt wird. Sollten Sie ein Gerät mit
                    einem Betriebssystem der Firma Apple (iOS) verwenden, setzen
                    wir zusätzlich den Dienst “Apple Push Notification Services”
                    ein. Diese Dienste der Betriebssystemhersteller erzeugen auf
                    Ihrem Smartphone einen wertneutralen Sicherheitsschlüssel,
                    den wir auf dem Server den Universitätsmedizin Mainz mit
                    ...
                    Fragebogen zur Verfügung steht. Hierzu senden wir den Text
                    der entsprechenden Benachrichtigung (z.B. “Es steht ein
                    neuer Fragebogen für Sie bereit.”) mit dem von FCM erzeugten
                    Sicherheitsschlüssel an die Firma Google sowie bei
                    iOS-Geräten an die Firma Apple. In diesen Fällen können
                    Daten ohne geeignete Garantien i.S.d. Art. 46 DSGVO an alle
                    Google- bzw. Apple-Rechenzentren (auch in Nicht-EU-Ländern
                    ohne angemessenes Datenschutzniveau, insbesondere USA)
                    übertragen werden. Mit Urteil vom 16.07.2020, Az.: C-311/18
                    („Schrems II“) hat der EuGH festgestellt, dass in den USA
                    kein angemessenes Datenschutzniveau gewährleistet werden
                    kann. Es besteht dort zum einen das Risiko eines Zugriffs
                    auf die übertragenen Daten durch US-Sicherheitsbehörden
                    ohne, dass eine Möglichkeit vorgesehen ist, wirksame
                    Rechtsbehelfe einzulegen. Zum anderen fehlen durchsetzbare
                  ...
                  <Text style={localStyle.p}>
                    ...
                    Behörden und Gerichte kontrolliert werden kann und/oder
                    Ihnen durchsetzbare Rechte und wirksame Rechtsbehelfe zur
                    Verfügung stehen. Des Weiteren können umfangreichere
                    Zugriffsrechte durch staatliche Organe und/oder private
                    Stellen bestehen, wodurch Ihnen erhebliche persönliche
                  ...
                  <Text style={localStyle.b}>
                    ...
                    informieren wir Sie im Folgenden über Ihre Rechte in Bezug
                  ...
                  <Text localStyle={localStyle.p}>
                    Wir verarbeiten folgende personenbezogene Daten im Rahmen
                    der Studie:
                  </Text>
                  ...
                  <Text style={localStyle.p}>
                    ...
                    benannten Studie verarbeiteten personenbezogenen Daten ist
                    Ihre Einwilligungserklärung gemäß Art. 7 und Art. 9 Abs. 2
                    lit. a) DS-GVO und § 37 Abs. 1 Landeskrankenhausgesetz
                    Rheinland-Pfalz (LKG RLP).
                  </Text>
                  ...
                  <View style={localStyle.list}>
                    <View style={localStyle.item}>
                      ...
                      <Text style={localStyle.shrink}>
                        Die pseudonymisierten Daten werden auf die NUM-Plattform
                        der Universitätsmedizin Mainz übermittelt und dort
                        gespeichert.
                      </Text>
                    </View>
                    <View style={localStyle.item}>
                      ...
                      <Text style={localStyle.shrink}>
                        ...
                        personenbezogenen Daten werden anonymisiert an folgende
                        Empfänger/Kategorien von Empfängern[1] weitergegeben:
                      </Text>
                    </View>
                    <Text style={localStyle.p}>
                      Die mit der Durchführung der Studie betrauten Personen in
                  ...
                  <View style={localStyle.list}>
                    ...
                    <View style={localStyle.item}>
                      ...
                      <Text style={localStyle.shrink}>
                        ...
                        möglich machen, weshalb nach der Anonymisierung auch
                        keine Löschung Ihrer zu Studienzwecken erhobenen Daten
                        aus der Studie möglich ist.
                      </Text>
                    </View>
                  </View>
                  <Text style={localStyle.p}>
                    ...
                    Ihren Daten und damit keine Durchsetzung der folgenden
                    Rechte möglich;
                  </Text>
                  <View style={localStyle.list}>
                    <Text style={localStyle.p}>
                      ...
                      verarbeitet werden. Das Recht auf Auskunft kann im Sinne
                      des § 27 Abs. 2 BDSG eingeschränkt werden, also wenn Daten
                      nicht automatisiert – etwa nur papierhaft – verarbeitet
                      werden.
                    </Text>
                    <Text style={localStyle.p}>
                      <Text style={localStyle.u}>
                      ...
                      personenbezogene Daten berichtigen zu lassen. Das Recht
                      auf Berichtigung kann im Sinne des § 27 Abs. 2 BDSG
                    ...
                    <Text style={localStyle.p}>
                      <Text style={localStyle.u}>
                        Recht auf Einschränkung der Verarbeitung nach Artikel
                        18, 19 DS-GVO:{"\n"}
                      </Text>
                    ...
                    <Text style={localStyle.p}>
                      ...
                      personenbezogenen Daten, die sie dem Verantwortlichen für
                      die Studie bereitgestellt haben, zu erhalten. Damit können
                      Sie beantragen, dass diese Daten entweder Ihnen oder,
                      soweit technisch möglich, einer anderen von Ihnen
                      benannten Stelle übermittelt werden.
                    </Text>
                    <Text style={localStyle.p}>
                      <Text style={localStyle.u}>
                      ...
                      einzulegen. Das Recht kann im Sinne des § 27 Abs. 2 BDSG
                      eingeschränkt werden.
                    </Text>
                  </View>
                  <Text style={localStyle.p}>
                  ...
                  <Text style={localStyle.p}>
                    ...
                    Für die Verarbeitung der anonymisierten Daten ist rechtlich
                    verantwortlich:
                  </Text>
                  <Text style={localStyle.list}>
                  ...
                  <Text style={localStyle.p}>
                    Kontaktdaten des Datenschutzbeauftragten des LMU Klinikums:
                  </Text>
                  <Text style={localStyle.list}>
                    Gerhard Meyer{"\n"}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Text style={localStyle.p}>
                    Ich habe verstanden und bin ausdrücklich damit
                    einverstanden,
                  </Text>
                  <View style={localStyle.list}>
                    <View style={[localStyle.item]}>
                      ...
                      <Text style={[localStyle.shrink]}>
                        ...
                        personenbezogenen Daten u.a. durch die S.A.M.-App
                    ...
                    <View style={[localStyle.item]}>
                      ...
                      <Text style={[localStyle.shrink]}>
                        dass meine Daten ausschließlich zum oben benannten
                        Zwecke und nur durch Studienmitarbeiter:innen bzw. die
                        benannten Empfänger bzw. Kategorien von Empfängern
                        verarbeitet werden;
                      </Text>
                    </View>
                    <View style={[localStyle.item]}>
                      ...
                      <Text style={[localStyle.shrink]}>
                        dass für den Zweck der o.g. Studie meine
                        pseudonymisierten Studiendaten an mit der Durchführung
                        der Studie betraute Mitarbeitende der folgenden
                        Einrichtungen der Universitätsmedizin Mainz übermittelt
                        werden:
                      </Text>
                    </View>
                    <View style={localStyle.list}>
                      ...
                      <View style={localStyle.item}>
                        ...
                        <Text style={localStyle.shrink}>
                          Klinik für Psychosomatische Medizin und Psychotherapie
                          und Institut für Arbeits-, Sozial- und Umweltmedizin
                        </Text>
                      </View>
                      <View style={localStyle.item}>
                        <Text style={localStyle.enum}>-</Text>
                  ...
                  <Text style={[localStyle.b, localStyle.p]}>
                    ...
                    entstehen. Meine personenbezogenen Daten werden in diesem
                    Fall gelöscht. Mein Widerruf wird erst ab dem Zeitpunkt des
                  ...
                  <Text style={[localStyle.b, localStyle.p]}>
                    Ich habe verstanden und bin ausdrücklich damit
                    einverstanden, dass (ausschließlich) zum Zwecke der
                    Benachrichtigung über neue Fragebögen die Push-Services der
                    Betriebssystemhersteller Google und Apple (Firebase Cloud
                    Messaging) eingesetzt werden. Diese Firmen betreiben Server
                    in Ländern außerhalb der Europäischen Union und des
                    Europäischen Wirtschaftsraumes (insb. USA), in denen ein
                    Schutz meiner Daten nicht in vergleichbarer Weise garantiert
                    werden kann. Es werden keine von mir selbst eingegeben oder
                    anderweitig über die App erhobenen Daten an Google- oder
                    Apple-Server gesendet.
                  </Text>
                  <CheckBox
                    center
                    accessibilityRole="button"
