            ...
            >
              ...
              >
                ...
                <Text style={localStyle.p}>
                  ...
                  Ethikkommission am LMU Klinikum (Projektnummer: 23-0230).
                </Text>
                ...
                <Text style={localStyle.p}>
                  ...
                  des <Text style={localStyle.b}>PREPARED</Text>{" "}
                  ...
                  (BMBF) (Förderkennzeichen: 01KX2121) gefördert und steht unter
                  der Gesamtprojektleitung von Prof. Dr. Jochen Schmitt und
                  Prof. Dr. Simone Scheithauer. Die Wissenschaftler:innen der
                  Studie haben sich zum Ziel gesetzt, Mitarbeitenden von
                  Kliniken in Deutschland die Möglichkeit zu geben, ihre mentale
                  Gesundheit am Ende bzw. nach der COVID-19-Pandemie zu
                  monitoren. Dies soll dazu beitragen, bei einer zukünftigen
                  Gesundheitskrise oder -katastrophe zeitnah die mentale
                  Gesundheit von Mitarbeitenden in Kliniken erfassen und
                  evaluieren zu können. Darüber hinaus verfolgt die Studie
                  ...
                  Interventionen zu erhalten. Besonders die Faktoren Burnout als
                  arbeitsbezogenes Beanspruchungsmerkmal soll untersucht und
                  präventive Faktoren (z. B. Selbstwirksamkeit oder soziale
                  Unterstützung) zur Vermeidung analysiert werden. Ziel der
                  Studie ist, Merkmale zu identifizieren, die vor der
                  Entwicklung psychischer Störungen schützen. Bitte beachten
                  Sie, dass Sie an der Studie nur teilnehmen können, wenn Sie
                  mindestens 18 Jahre alt sind und einwilligen, dass Ihre Daten
                  für die oben beschriebenen Zwecke genutzt werden.
                </Text>
                <Text
                  style={[
                    localStyle.center,
                ...
                <Text style={localStyle.p}>
                  ...
                  drei Monaten in einem zwei-wöchentlichen Rhythmus Fragen zu
                  Ihrer psychischen Gesundheit stellen. Insgesamt werden Sie 7
                  Fragebögen (1 Start-Fragebogen, 6 wöchentliche Fragebögen)
                  ausfüllen können. Die Studie startet im Frühjahr 2023. Der
                  Zeitraum der Befragung erstreckt sich über drei Monate.
                </Text>
                <Text style={localStyle.p}>
                  <Text style={localStyle.b}>Voraussetzungen:{"\n"}</Text>
                  Um an der Studie teilnehmen zu können, müssen Sie sich die für
                  die Studie entwickelte S.A.M.-App auf Ihr Smartphone
                ...
                <Text style={localStyle.p}>
                  ...
                  technische und organisatorische Maßnahmen zu ergreifen, um
                ...
                <Text style={localStyle.p}>
                  Die Teilnahme an dieser Studie ist freiwillig. Ihnen entstehen
                  keine Nachteile durch Versagen der Einwilligung. Sie können
                  zudem jederzeit und ohne Angabe von Gründen Ihre Einwilligung
                  zur Teilnahme an der Studie widerrufen (schriftlich oder per
                  E-Mail) und der Weiterverarbeitung Ihrer Daten widersprechen,
                  ohne dass Ihnen dadurch Nachteile entstehen. Ihre
                  personenbeziehbaren Daten werden in diesem Fall gelöscht. Die
                  zu diesem Zeitpunkt bereits anonymisierten Daten können nicht
                  gelöscht werden, da Ihnen diese Daten nicht mehr zugeordnet
                  werden können. Ihr Widerruf wird erst wirksam ab dem Zeitpunkt
                  des Zuganges der Erklärung bei der Universitätsmedizin Mainz.
                  Er hat keine Rückwirkung, d.h. die Verarbeitung Ihrer Daten
                  bis zu diesem Zeitpunkt bleibt rechtmäßig.
                </Text>
                <Text style={[localStyle.b, localStyle.center, localStyle.u]}>
                ...
                <Text style={localStyle.p}>
                  ...
                  Daten von Ihnen wie z.B. Ihr Name, Adresse, Email-Adresse oder
                  Geburtsdatum erhoben. Sämtliche sonstige, zur Auswertung
                  notwendige Metadaten werden in pseudonymisierter Form erhoben.
                  Pseudonymisiert bedeutet, dass Ihre personenbezogenen Daten
                  durch einen wertneutralen Code (z.B. XYZ01) ersetzt werden.
                  Über den wertneutralen Code kann das Studienpersonal nach
                  Beendigung der Studie die von Ihnen übersandten Fragebögen
                  zuordnen und auswerten. Eine Beratung durch den
                  Datenschutzbeauftragten der Universitätsmedizin Mainz hat
                  stattgefunden.
                </Text>
                <Text style={localStyle.p}>
                ...
                <View style={localStyle.list}>
                  ...
                  <View style={localStyle.item}>
                    <Text style={localStyle.enum}>•</Text>
                    <Text style={localStyle.shrink}>
                      Berufsbezogene Daten zu Funktion, Fachbereich, Einsatzort
                    </Text>
                  </View>
                  <View style={localStyle.item}>
                    <Text style={localStyle.enum}>•</Text>
                ...
                <View style={localStyle.list}>
                  ...
                  <View style={localStyle.item}>
                    ...
                    <Text style={localStyle.shrink}>
                      ...
                      Daten werden anonymisiert an folgende Empfänger/Kategorien
                      von Empfängern[1] weitergegeben:
                    </Text>
                  </View>
                  <Text style={localStyle.p}>
                  ...
                  <View style={localStyle.item}>
                    ...
                    <Text style={localStyle.shrink}>
                      ...
                      werden) oder eine Veröffentlichung findet, wenn überhaupt,
                      nur in anonymisierter Form statt.
                    </Text>
                  </View>
                </View>
                ...
                <Text style={localStyle.p}>
                  LMU Klinikum, Klinik für Psychiatrie und Psychotherapie
                  (Nußbaumstraße 7, 80336 München): PSY.NUM@med.uni-muenchen.de{" "}
                </Text>
