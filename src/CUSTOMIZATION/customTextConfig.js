...
export default {
	...
	"generic":{
		...
		"eraseLocalDataAtEndOfStudyText":"Möchten sie wirklich alle lokalen Daten löschen und sich ausloggen? Dies kann nicht rückgängig gemacht werden!",
	...
	"survey":{
		...
		"endedStudyText":"Die Studie ist für Sie nun beendet. Vielen herzlichen Dank für Ihre Teilnahme.\n\n Sie können sich nun ausloggen, alle Daten löschen un die App deinstallieren.",
